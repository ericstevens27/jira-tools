...
def usage():
    usageMsg = "This program uses the JIRA Rest API to clone selected issues and move them through a transition to Closed.\n\
    Usage is:\n\
    ...
    The file must include a header and at least one column: [IssueKey]\n\
    \n"
    print(usageMsg)
...
with open(inputFile, newline='') as f:
    ...
    for row in reader:
        ...
        # spaces
        if debug:
            print("Current versions are ", issue.fields.fixVersions)
